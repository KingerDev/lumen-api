    ...
    */
    ...
    'disks' => [
        ...
        'r2' => [
            ...
            // Deliberately R2_* and not the stock AWS_* names: a default Laravel
            // .env ships AWS_DEFAULT_REGION=us-east-1 and
            // AWS_USE_PATH_STYLE_ENDPOINT=false, which would silently override
            // the values R2 needs and break every presigned URL.
